...
const GoalCard : React.FC<GoalCardProps> = ({goal, onViewTasks, classname }) => {
    ...
    return (
        <Card className={`bg-[#FDE3EC] border-none shadow-none w-[300px] font-poppins ${classname}`}>
            <CardContent className="p-6 flex flex-col justify-between h-full">
                ...
                <p className="text-xs mt-3">{goal.description}</p>
